...
| ------------------------------------------------ | ---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | ----------------------------------------------------------------------------------------------------------- | ----------------------------------------------------------------------------------- |
| <mark style="color:blue;">**Rare**</mark>        | Shoot out a Fireball which explode at the **last impact** deal **0.8X** damage of Focus Arrow in a large **AOE (0.5 rad)**                                                                                                                                                   | Shoot out multiple Fire-arrow which reduce the **Fire resistance** of monster by **25%** for **8 seconds**  | Stamina cost is multiplied by **1.7** for **Focus** and **1.2** for **Multi** Shoot |
| <mark style="color:purple;">**Epic**</mark>      | <p>Shoot out a Fireball which explode at the <strong>last impact</strong> deal <strong>1.2X</strong> damage of Focus Arrow. The fireball can also explode at the <strong>first impact</strong> deal <strong>0.6X</strong> damage  <br><strong>AOE (0.9/0.5 rad)</strong></p> | Shoot out multiple Fire-arrow which reduce the **Fire resistance** of monster by **30%** for **8 seconds**  | Stamina cost is multiplied by **2.1** for **Focus** and **1.4** for **Multi** Shoot |
| <mark style="color:yellow;">**Legendary**</mark> | Shoot out a Fireball which explode at the **last impact** deal **1.6X** damage of Focus Arrow. The fireball can also explode at the **first 3 impacts** deal **0.9X** damage  **AOE (1.25/0.5 rad)**                                                                         | Shoot out multiple Fire-arrow which reduce the **Fire resistance** of monster by **35%** for **12 seconds** | Stamina cost is multiplied by **2.5** for **Focus** and **1.6** for **Multi** Shoot |
...
| Rarity Level                                     | Focus shoot                                                                                                                                                                                                                                                                                                                                                                   | Multi shoot                                                                                                                                       | Properties                                                                          |
| ------------------------------------------------ | ----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | ------------------------------------------------------------------------------------------------------------------------------------------------- | ----------------------------------------------------------------------------------- |
| <mark style="color:blue;">**Rare**</mark>        | Shoot out a Wind-ball which explode at the **last impact** deal **0.4X** damage of Focus Arrow in a large **AOE (0.5 rad)** Monster hit by explosion will be **knock back 3m**                                                                                                                                                                                                | Shoot out multiple Wind-arrow which  **knock back 1m** when **** hitting the monster. Monster can be push many times if hit by multiple arrows    | Stamina cost is multiplied by **1.6** for **Focus** and **1.2** for **Multi** Shoot |
| <mark style="color:purple;">**Epic**</mark>      | <p>Shoot out a Wind-ball which explode at the <strong>last impact</strong> deal <strong>0.6X</strong> damage of Focus Arrow. The Wind-ball can also explode at the <strong>first impact</strong> deal <strong>0.4X</strong> damage.</p><p><strong>AOE (0.9/0.5 rad)</strong> <br><strong></strong>Monster hit by any explosion will be <strong>knock back 4.5m</strong></p>   | Shoot out multiple Wind-arrow which  **knock back 1.25m** when **** hitting the monster. Monster can be push many times if hit by multiple arrows | Stamina cost is multiplied by **2.0** for **Focus** and **1.4** for **Multi** Shoot |
| <mark style="color:yellow;">**Legendary**</mark> | <p>Shoot out a Wind-ball which explode at the <strong>last impact</strong> deal <strong>0.8X</strong> damage of Focus Arrow. The Wind-ball can also explode at the <strong>first 3 impacts</strong> deal <strong>0.6X</strong> damage.</p><p><strong>AOE (1.25/0.5 rad)</strong> <br><strong></strong>Monster hit by any explosion will be <strong>knock back 6m</strong></p> | Shoot out multiple Wind-arrow which  **knock back 1.5m** when **** hitting the monster. Monster can be push many times if hit by multiple arrows  | Stamina cost is multiplied by **2.4** for **Focus** and **1.6** for **Multi** Shoot |
...
_<mark style="color:red;">This orb of Ice is currently buffed by 20% due to Winter Season</mark>_

| Rarity Level                                     | Focus shoot                                                                                                                                                                                                                                                                                     | Multi shoot                                                                                                                                                   | Properties                                                                          |
| ------------------------------------------------ | ----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------- | ----------------------------------------------------------------------------------- |
| <mark style="color:blue;">**Rare**</mark>        | Shoot out a Ice-shard which explode at the **last impact** deal **0.48X** damage of Focus Arrow in a medium **AOE (0.75 rad)** Monster hit by explosion will be **slow 55% MS and -55 AS for 3 seconds**                                                                                        | Shoot out multiple Ice-arrow which  **slow 24% MS and -24 AS for 8 seconds** when **** hitting the monster. Slow doesn't stack, only strongest slow applied.  | Stamina cost is multiplied by **1.6** for **Focus** and **1.1** for **Multi** Shoot |
| <mark style="color:purple;">**Epic**</mark>      | Shoot out a Ice-shard which explode at the **last impact** deal **0.72X** damage of Focus Arrow. The Ice-shard can also explode at the **first impact** deal **0.48X** damage at a smaller **AOE (0.25 rad)** Monster hit by explosion will be **slow 65% MS and -65 AS for 3 seconds**         | Shoot out multiple Ice-arrow which  **slow 36% MS and -36 AS for 10 seconds** when **** hitting the monster. Slow doesn't stack, only strongest slow applied. | Stamina cost is multiplied by **2.0** for **Focus** and **1.3** for **Multi** Shoot |
| <mark style="color:yellow;">**Legendary**</mark> | Shoot out a Ice-shard which explode at the **last impact** deal **0.96X** damage of Focus Arrow. The Ice-shard can also explode at the **first 3 impacts** deal **0.72X** damage at a smaller **AOE (0.25 rad).** Monster hit by any explosion will be **slow 85% MS and -85 AS for 3 seconds** | Shoot out multiple Ice-arrow which  **slow 48% MS and -48 AS for 12 seconds** when **** hitting the monster. Slow doesn't stack, only strongest slow applied. | Stamina cost is multiplied by **2.4** for **Focus** and **1.5** for **Multi** Shoot |
