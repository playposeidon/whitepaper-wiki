...
![](<../../.gitbook/assets/image (1).png>)![](<../../.gitbook/assets/image (3).png>)![](<../../.gitbook/assets/image (2).png>)
...
<figure><img src="../../.gitbook/assets/Chaos Charm.png" alt=""><figcaption><p>Chaos Charm</p></figcaption></figure>

This is a **Premium Item** which will allow the Player to not worry about his **NFT Orb will be burned** if the upgrade is failed when upgrading Orb starting from **Orb+9** to **Orb+18**. The more number of **Chaos Charm** you have the better it can protect your Orb from failing from the current Level when the upgrade failed. To understand, please read this table below:

| Orb LV             | Number of Chaos Charm before upgrade | Number of Chaos Charm After failed upgrade |
| ------------------ | ------------------------------------ | ------------------------------------------ |
| Orb+9              | 0: Orb will be Burned                | 0: Orb is Burned, Deduct 0                 |
| Orb+9              | 1: Orb LV will back to +8            | 0: Orb LV= +8, Deduct 1                    |
| Orb+9              | 2: Orb LV will back to +8            | 1: Orb LV= +8, Deduct 1                    |
| Orb+10             | 0: Orb will be Burned                | 0: Orb is Burned, Deduct 0                 |
| Orb+10             | 1: Orb LV will back to +8            | 0: Orb LV= +8, Deduct 1                    |
| Orb+10             | 2: Orb LV will back to +9            | 0: Orb LV= +9, Deduct 2                    |
| Orb+11             | 0: Orb will be Burned                | 0: Orb is Burned, Deduct 0                 |
| Orb+11             | 1: Orb LV will back to +8            | 0: Orb LV= +8, Deduct 1                    |
