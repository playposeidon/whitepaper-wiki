...
**Bonus Damage when Active**: This amount increases Hero base damage when the orb is Activated. This bonus base damage can be further increased by upgrading Orb to higher Level(see [Orb Upgrade](orb-upgrade-and-level.md)). This amount will not be increased by any Attribute Bonus Buff
