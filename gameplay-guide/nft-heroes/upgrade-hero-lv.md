...
| Hero LV2   | 40 EXP (LV1 -> LV2)                                         | 240 EXP     |
...
| Hero LV7\* | 32000 EXP LV6 -> LV7) + **Upgrade Scroll Level 7**          | ?           |
| Hero LV8\* | ? EXP (LV7 -> LV8) + **Upgrade Scroll Level 8**             | ?           |
| Hero LV9\* | ? EXP (LV8 -> LV9) + **Upgrade Scroll Level 9**             | ?           |
...
| LV6 -> LV7\*       | 23x farm-cap | 23x farm-cap | 25x farm-cap |
| LV7 -> LV8\*       | ?            | ?            | ?            |
| LV8 -> LV9\*       | ?            | ?            | ?            |
...
In order to upgrade Hero to LV7 LV8 LV9 and above, player will be required to have **Upgrade Scroll** of corresponding level. This item can be acquired by open **Boss** __ **Treasures** , **** drop rate can be found here: [#3.1-common-treasure](../../playposeidon/earn-mechanism/gacha-items.md#3.1-common-treasure "mention") ****&#x20;

Higher Hero Tier will require more number of **Upgrade Scroll** than lower tier according to this table

| Hero Tier                                     | Normal Upgrade | Quick Upgrade |
| --------------------------------------------- | -------------- | ------------- |
| <mark style="color:red;">**S-Tier**</mark>    | 12             | 24            |
| <mark style="color:yellow;">**A-Tier**</mark> | 6              | 12            |
| <mark style="color:purple;">**B-Tier**</mark> | 6              | 12            |
| <mark style="color:green;">**C-Tier**</mark>  | 2              | 4             |
| <mark style="color:blue;">**D-Tier**</mark>   | 2              | 4             |
...
| Hero Level | Burn a NFT Hero to Upgrade another one                | Note                                            |
| ---------- | ----------------------------------------------------- | ----------------------------------------------- |
| Hero LV1   | None                                                  |                                                 |
