...
![](../../.gitbook/assets/metamask\_setup\_1.png)
...
![](../../.gitbook/assets/metamask\_setup\_4.png)
...
After complete the Metamask wallet setup, now navigate to the game at: [https://game.playposeidon.io](https://game.playposeidon.io)

A Select Wallet window will appear, then you chose **MetaMask**:

![](../../.gitbook/assets/metamask\_login\_1.png)

If your Metamask is not setup correctly with BSC network then a prompt will appear to ask you to switch to the correct one.

After this step, a Metamask window will popup to ask you to authorize for login to PlayPoseidon.io, please click <mark style="color:blue;background-color:blue;">**Sign**</mark> to login to play the game.

![](../../.gitbook/assets/metamask\_login\_2.png)

Finally you can see the PlayPoseidon game menu, click Play to start the game.
