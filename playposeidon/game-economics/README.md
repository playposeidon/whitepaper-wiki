...
2. **On-chain PPP** token: Receive when you claim your **In-Game PPP** token after Tax deduction. Or from swapping **PPP/BNB** token pair on DEX such as: Pancake Swap
...
For seller, When you sell NFTs via The In-Game NFT Market Place, you will receive **In-Game PPP** only in exchange for a very low commission fee. Also you can keep using your NFT Hero/Pet to play and _**farm reward while let them being listed**_ on the In-Game NFT Market Place.
